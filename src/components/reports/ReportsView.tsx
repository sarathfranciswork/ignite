...
import { PartneringReportTab } from "./PartneringReportTab";
...
type TabId = "platform" | "portfolio" | "analyzer" | "comparison" | "successFactors" | "partnering";
...
const TABS: Array<{ id: TabId; label: string; icon: typeof BarChart3 }> = [
  ...
  { id: "partnering", label: "Partnering", icon: Building2 },
];
...
export function ReportsView() {
  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab === "partnering" && <PartneringReportTab />}
    </div>
  );
}
