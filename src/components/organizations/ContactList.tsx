...
import { Plus, Mail, Phone, Linkedin, Star, Send, Pencil, Trash2 } from "lucide-react";
              ...
              >
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    {contact.inviteStatus !== "NOT_INVITED" && (
                      <span
                        className={`inline-flex rounded-full px-2 py-0.5 text-xs font-medium ${
                          contact.inviteStatus === "ACCEPTED"
                            ? "bg-green-50 text-green-700"
                            : contact.inviteStatus === "DECLINED"
                ...
                <div className="flex items-center gap-1">
                  {contact.email && contact.inviteStatus === "NOT_INVITED" && (
                    <Button
                      variant="ghost"
                      size="sm"
