...
export const Action = {
  ...
  AI_SCORE_IDEA: "ai.scoreIdea",
  AI_BATCH_SCORE: "ai.batchScore",
  AI_CATEGORIZE: "ai.categorize",
  AI_MANAGE_TAGS: "ai.manageTags",
  AI_SCOUTING: "ai.scouting",
...
export const GLOBAL_ROLE_PERMISSIONS: Record<GlobalRoleName, readonly ActionType[]> = {
  ...
  INNOVATION_MANAGER: [
    ...
    Action.AI_SUMMARIZE,
    Action.AI_SCORE_IDEA,
    Action.AI_BATCH_SCORE,
    Action.AI_CATEGORIZE,
    Action.AI_MANAGE_TAGS,
    Action.AI_SCOUTING,
    Action.SIA_CREATE,
    Action.SIA_READ,
    Action.SIA_UPDATE,
